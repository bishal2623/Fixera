...
import { CodeRefactorSuggestionsOutput } from '@/ai/flows/code-refactor-suggestions';
        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="space-y-6">
                <div>
                  <Label htmlFor="code-snippet" className="text-sm font-medium mb-2 block">
                    Code Snippet
                  </Label>
                  <Textarea
                    id="code-snippet"
                ...
                <div>
                  <Label htmlFor="coding-style" className="text-sm font-medium mb-2 block">
            ...
            <Card className="shadow-lg">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div
                        ...
                        style={{ animation: 'fade-in 0.5s ease-out', animationFillMode: 'forwards', animationDelay: `${idx * 100}ms`, opacity: 0 }}
                    >
