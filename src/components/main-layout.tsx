...
import { CodeXml, GraduationCap, Palette, BotMessageSquare } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/personalized-tutor', label: 'Personalized Tutor', icon: GraduationCap, tooltip: 'Personalized Tutor' },
];
