      ...
      <Card className="w-full max-w-md shadow-2xl">
        ...
        <CardContent>
          <div className="space-y-4">
            <Button variant="outline" className="w-full" onClick={handleGoogleSignIn} disabled={isLoading !== null}>
            ...
            <form onSubmit={isSignUp ? handleSignUp : handleSignIn} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="m@example.com" required disabled={isLoading !== null} />
              </div>
              <div className="space-y-2">
